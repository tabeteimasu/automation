...
import com.automation.pages.SignInNSentEmailPage;
import com.automation.pages.RegisterCourseraPage;
import com.automation.pages.RegisterHotmailPage;
import com.automation.pages.GameflipSoldItemsPage;
...
public class BaseTests {
	...
	SignInNSentEmailPage signInNSentEmailPage;
	GameflipSoldItemsPage gameflipSoldItemsPage;
	...
	public void setup() throws Exception{
		...
		signInNSentEmailPage = new SignInNSentEmailPage(driver);
		gameflipSoldItemsPage = new GameflipSoldItemsPage(driver);
