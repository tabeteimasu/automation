...
//	private List<WebElement> prices;
	...
	public void printItemsInDescendingOrder() {
	    ...
	    double totalPrice=0;
	    double totalScrip = 0,totalMod = 0;
	    ...
	    for (GameflipItemEntry entry : itemPriceList) {
	        ...
	        //Calculate the total price of SCRIP
	        if(entry.getItemName().contains("SCRIP"))
	        	totalScrip += entry.getTotalPrice();
	        
	        if(entry.getItemName().contains("MOD"))
	        	totalMod += entry.getTotalPrice();
	    ...
	    System.out.printf("Total Price Of SCRIP: $%.2f%n", totalScrip);
	    System.out.printf("Total Price Of MOD: $%.2f%n", totalMod);
	    System.out.println("______________________________________");
